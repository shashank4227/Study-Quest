...
const Login = () => {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold font-heading text-white mb-1">Welcome back</h1>
      <p className="text-slate-400 text-sm mb-8">Log in to continue your quest</p>
      ...
      <p className="mt-6 text-center text-sm text-slate-400">
        ...
        <Link to="/register" className="text-[#1591DC] font-semibold hover:underline">Sign up free</Link>
      </p>
    </div>
  );
};
